                            ...
                            child: Card(
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(listDoa[widget.idDoa]['arab'],textAlign: TextAlign.end,style: TextStyle(fontSize: 26)),
                                      //
                                      SizedBox(height: 10,),
                                      Text(listDoa[widget.idDoa]["latin"].toString(),textAlign: TextAlign.start,style: TextStyle(fontSize: 16),),
                                      SizedBox(height: 15,),
